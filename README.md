...
Turbo Chess source code is released under the GNU General Public License version 3. The full license text is available in LICENSE.
...
Release signing and local configuration files are excluded from version control. See docs/SECRETS_AND_SIGNING.md for signing and secret-handling notes.
