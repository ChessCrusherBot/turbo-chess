...
The Android app also includes practical legal/source information in More â†’ Legal.

## Stockfish

Turbo Chess includes Stockfish, licensed under GPLv3.

For local release builds, Stockfish native binaries are expected at:
...
Release signing depends on a developer's own local signing setup.

Local files such as `android/local.properties` are generated by Flutter or Android Studio and are not part of the public repository.
